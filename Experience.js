      ...
      <div class="container-fluid p-0">
        ...
        {/* <section class="resume-section" id="about">
          <div class="resume-section-content">
            <h1 class="mb-0">
              Syed 
              <span class="text-primary"> Zain Ul Abideen</span>
            </h1>
            <div class="subheading mb-5">
            CII Block Johar Town, Lahore· (+92) 3321660225 · ·
              <a href="mailto:syed.zain2261@email.com">syed.zain2261@email.com</a>
            </div>
            <p class="lead mb-5">
          ...
          <div class="resume-section-content">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div class="flex-grow-1">
                <h3 class="mb-0">React JS Intern</h3>
                <div class="subheading mb-3">Process.com.pk</div>
                <p>
              ...
              <div class="flex-shrink-0">
                <span class="text-primary">August 2023 - September 2023</span>
              </div>
            </div>
            <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div class="flex-grow-1">
